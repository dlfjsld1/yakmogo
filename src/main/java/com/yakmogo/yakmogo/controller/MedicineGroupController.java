...
public class MedicineGroupController {
	...
	public ResponseEntity<String> deleteMedicine(@PathVariable @Positive Long groupId) {
	...
	public ResponseEntity<List<MedicineGroup>> getMedicines(@PathVariable @Positive Long userId) {
