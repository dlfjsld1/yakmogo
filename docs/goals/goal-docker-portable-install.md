...
**격리 1단계 완료, 현재 enhancement DB 이동 승인 대기.** 2026-07-15 GitHub-hosted ARM64 검증에서 신규 설치, Flyway bootstrap, SQL 백업, 빈 volume 복원, 데이터 확인과 고장 image 자동 rollback이 성공했다. Pi, 현재 8081, host DB, 운영 8080과 `main`은 변경하지 않았다.
