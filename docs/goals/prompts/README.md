...
| 5 | [백엔드 API 테스트·검증·상태 전이](goal-05-backend-test-suite.md) | 완료 | [완료 보고](../goal-05-backend-test-suite.md) |
| 6 | [React 약 관리 UI·UX](goal-06-medicine-ui.md) | 완료 | [완료 보고](../goal-06-medicine-ui.md) |
| 7 | [스케줄러·Telegram 알림 신뢰성](goal-07-notification-reliability.md) | 완료 | [완료 보고](../goal-07-notification-reliability.md) |
| 8 | [CI/CD와 8081 자동 배포·롤백](goal-08-ci-cd.md) | 완료, JAR 방식은 Docker로 대체 | [완료 보고](../goal-08-ci-cd.md) |
| D | [단일 명령 Docker 설치와 수동 업데이트](goal-docker-portable-install.md) | 완료 | [실행 기록](../goal-docker-portable-install.md) |
| 9 | [관측성·백업·복원](goal-09-operations.md) | 완료 | [완료 보고](../goal-09-operations.md) |
| 10 | [전체 검증과 main 승격](goal-10-release-readiness.md) | main 보존·승격 준비 | [진행 보고](../goal-10-release-readiness.md) |

권장 순서는 `1 → 2 → 3 → 4 → 5 → 6 → 7 → 8 → Docker D → 9 → 10`이다. Docker D에서 설치·DB container·수동 업데이트 경계를 먼저 확정한 뒤 Goal 9가 해당 구조의 백업과 관측성을 완성한다.
...
6. Goal 10 전까지 `main`과 운영 8080을 변경하지 않는다.
