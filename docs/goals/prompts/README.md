...
| 4 | [Flyway 기반 DB 마이그레이션](goal-04-database-migration.md) | 승인 지점 1 | [사전 분석](../goal-04-database-migration.md) |
| 5 | [백엔드 API 테스트·검증·상태 전이](goal-05-backend-test-suite.md) | 대기 | 실행 전 |
