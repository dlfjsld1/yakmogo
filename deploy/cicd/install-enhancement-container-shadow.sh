...
helper_source=$repository_root/deploy/cicd/yakmogo-enhancement-container-shadow
sudoers_source=$repository_root/deploy/cicd/yakmogo-enhancement-container-shadow.sudoers
...
install -o root -g root -m 0755 "$helper_source" \
  /usr/local/sbin/yakmogo-enhancement-container-shadow
...
echo "enhancement container shadow deployer installed"
